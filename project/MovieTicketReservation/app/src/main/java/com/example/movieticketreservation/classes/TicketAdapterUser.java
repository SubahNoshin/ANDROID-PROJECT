...
public class TicketAdapterUser extends RecyclerView.Adapter<TicketAdapterUser.ItemViewHolder> {

    Context context;
    ArrayList<EachTicket> tickets;

    public TicketAdapterUser(Context context, ArrayList<EachTicket> tickets) {
